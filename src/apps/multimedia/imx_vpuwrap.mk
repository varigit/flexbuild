...
imx_vpuwrap:
	@[ $(DISTROVARIANT) != desktop -o $(SOCFAMILY) != IMX ] && exit || \
	 ...
	 ./autogen.sh --prefix=/usr --host=$ARM_LINUX_GNU_TOOLCHAIN --with-sysroot=$(RFSDIR) 1>/dev/null && \
	 ...
	 $(MAKE) DEST_DIR=$(DESTDIR) SDKTARGETSYSROOT=$(DESTDIR) CC=$ARM_LINUX_GNU_TOOLCHAIN-gcc && \
